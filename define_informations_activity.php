...
define('SQL_GET_WORKER', 'SELECT activity_member_usr_id, profil_fname, profil_name from tw_activity_member, tw_profil
where activity_member_activity_id = \'%d\'
and activity_work = 1
and profil_usr_id = activity_member_usr_id;');

define('SQL_CHECK_WORK_ACTIVITY', 'SELECT activity_member_activity_id, activity_name from tw_activity_member, tw_activity
where activity_member_activity_id != \'%d\'

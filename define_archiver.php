...
define('SQL_GET_ACTIVITY_ARCH', 'select activity_id from tw_archive where archive_id = \'%d\';');
...
define('ARCHIVER_CURRENT_FOLDER_START', '<current_folder name="%s" id="%d" folder="%d" activity="%d">');

...
define('MEMBER_ELEM_ACTIVITY', '<member><id>%d</id><editable>%d</editable><name>%s</name><fname>%s</fname><title>%s</title><role>%s</role><level post="modlevel">%d</level><work post="modwork">%d</work></member>');

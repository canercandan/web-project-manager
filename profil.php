...
printf(PROFIL_FIELD_ADDRESS,
  ...
  if ($_POST[PROFIL_POST_EMAIL])
    printf(PROFIL_FIELD_EMAIL, PROFIL_POST_EMAIL, $_POST[PROFIL_POST_EMAIL]);
  else
    printf(PROFIL_FIELD_EMAIL, PROFIL_POST_EMAIL, $_SESSION[SESSION_EMAIL]);
printf(PROFIL_END);
printf(XML_FOOTER);
sql_close($link);

...
{
  $_POST[PROFIL_POST_NAME] = $_SESSION['MEMBER_NAME'];
  $_POST[PROFIL_POST_FNAME] = $_SESSION['MEMBER_FNAME'];
  $_POST[PROFIL_POST_FPHONE] = $_SESSION['MEMBER_FPHONE'];
  $_POST[PROFIL_POST_MPHONE] = $_SESSION['MEMBER_MPHONE'];
  $_POST[PROFIL_POST_ADDRESS] = $_SESSION['MEMBER_ADDRESS'];
  printf(PROFIL_FIELD_LOCATION_BEGIN, PROFIL_POST_LOCATION, $_SESSION['MEMBER_LOCATION']);
  select_location();
  printf(PROFIL_FIELD_LOCATION_END);
  printf(PROFIL_FIELD_TITLE_BEGIN, PROFIL_POST_TITLE, $_SESSION['MEMBER_TITLE']);
  select_title();
  printf(PROFIL_FIELD_TITLE_END);
}
...
function profil_update()
{
  ...
  $_SESSION['MEMBER_NAME'] = $_POST[PROFIL_POST_NAME];
  $_SESSION['MEMBER_FNAME'] = $_POST[PROFIL_POST_FNAME];
  $_SESSION['MEMBER_FPHONE'] = $_POST[PROFIL_POST_FPHONE];
  $_SESSION['MEMBER_MPHONE'] = $_POST[PROFIL_POST_MPHONE];
  $_SESSION['MEMBER_ADDRESS'] = $_POST[PROFIL_POST_ADDRESS];
  $_SESSION['MEMBER_LOCATION'] = $_POST[PROFIL_POST_LOCATION];
  $_SESSION['MEMBER_TITLE'] = $_POST[PROFIL_POST_TITLE];
}
